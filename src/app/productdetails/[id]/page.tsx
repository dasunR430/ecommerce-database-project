...
export default function ProductDetailsPage({params}: {params: {id: string}}) {
    ...
    const [data, setData] = useState<{ ProductName: string; Price: string; AvailableStock: string; PrimaryImage: string }>({ ProductName: '', Price: '', AvailableStock: '', PrimaryImage: '' });
                ...
                <div className="flex flex-col md:flex-row -mx-4">
                    <div className="md:flex-1 px-4">
                        <div className="h-[460px] rounded-lg bg-gray-200 mb-4 shadow-lg">
                            <img className="w-full h-full object-cover rounded-lg" src={data.PrimaryImage} alt="Product Image" />
                        </div>
                    ...
                    <div className="md:flex-1 px-4">
                        <h2 className="text-3xl font-bold text-black mb-4">{data.ProductName}</h2>
                        ...
                        <div className="flex mb-6">
                            <div className="mr-4">
                                ...
                                <span className="text-gray-600 ml-2">Rs.{data.Price}</span>
                            </div>
                            <div>
                                <span className="font-bold text-gray-800">Availability:</span>
                                <span className="text-gray-600 ml-2">{data.AvailableStock} In Stock</span>
                            </div>
                        </div>
                        <div className="mb-6">
