      ...
      <div className="flex justify-between">
        <div className="flex-row">
          <ul className="hidden md:flex space-x-6 p-3">
            ...
            <li>
              <a href="/#category-section" className="text-white">Categories</a>
            </li>
            <li>
              <a href="/#trending-products" className="text-white">Trending</a>
            </li>
            <li>
              <a href="/#recommended-products" className="text-white">Recommended Products</a>
            </li>
            <li>
              <a href="/#brand-carousel" className="text-white">Brands</a>
            </li>
            <li>
              <a href="/#footer-section" className="text-white">About Us</a>
            </li>
          </ul>
        </div>
